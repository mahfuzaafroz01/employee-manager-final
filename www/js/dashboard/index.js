...
`;function xe(a){return document.createRange().createContextualFragment(a).firstElementChild}var T=xe;var Fe=function(){return T(G)},K=Fe;function Q(a,n,s){return s={path:n,exports:{},require:function(o,c){return Ie(o,c??s.path)}},a(s,s.exports),s.exports}function Ie(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var P={};function Y(a,n){for(var s=0,o=a.length-1;o>=0;o--){var c=a[o];c==="."?a.splice(o,1):c===".."?(a.splice(o,1),s++):s&&(a.splice(o,1),s--)}if(n)for(;s--;s)a.unshift("..");return a}var Me=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,q=function(a){return Me.exec(a).slice(1)};function M(){for(var a="",n=!1,s=arguments.length-1;s>=-1&&!n;s--){var o=s>=0?arguments[s]:"/";if(typeof o!="string")throw new TypeError("Arguments to path.resolve must be strings");if(!o)continue;a=o+"/"+a,n=o.charAt(0)==="/"}return a=Y(N(a.split("/"),function(c){return!!c}),!n).join("/"),(n?"/":"")+a||"."}function B(a){var n=k(a),s=Re(a,-1)==="/";return a=Y(N(a.split("/"),function(o){return!!o}),!n).join("/"),!a&&!n&&(a="."),a&&s&&(a+="/"),(n?"/":"")+a}function k(a){return a.charAt(0)==="/"}function ee(){var a=Array.prototype.slice.call(arguments,0);return B(N(a,function(n,s){if(typeof n!="string")throw new TypeError("Arguments to path.join must be strings");return n}).join("/"))}function te(a,n){a=M(a).substr(1),n=M(n).substr(1);function s(g){for(var _=0;_<g.length&&g[_]==="";_++);for(var w=g.length-1;w>=0&&g[w]==="";w--);return _>w?[]:g.slice(_,w-_+1)}for(var o=s(a.split("/")),c=s(n.split("/")),h=Math.min(o.length,c.length),m=h,u=0;u<h;u++)if(o[u]!==c[u]){m=u;break}for(var p=[],u=m;u<o.length;u++)p.push("..");return p=p.concat(c.slice(m)),p.join("/")}var ne="/",ae=":";function re(a){var n=q(a),s=n[0],o=n[1];return!s&&!o?".":(o&&(o=o.substr(0,o.length-1)),s+o)}function ie(a,n){var s=q(a)[2];return n&&s.substr(-1*n.length)===n&&(s=s.substr(0,s.length-n.length)),s}function se(a){return q(a)[3]}var Pe={extname:se,basename:ie,dirname:re,sep:ne,delimiter:ae,relative:te,join:ee,isAbsolute:k,normalize:B,resolve:M};function N(a,n){if(a.filter)return a.filter(n);for(var s=[],o=0;o<a.length;o++)n(a[o],o,a)&&s.push(a[o]);return s}var Re="ab".substr(-1)==="b"?function(a,n,s){return a.substr(n,s)}:function(a,n,s){return n<0&&(n=a.length+n),a.substr(n,s)},qe=Object.freeze({__proto__:null,resolve:M,normalize:B,isAbsolute:k,join:ee,relative:te,sep:ne,delimiter:ae,dirname:re,basename:ie,extname:se,default:Pe}),E=Q(function(a,n){var s=/[|\\{}()[\]^$+*?.]/g;n.escapeRegExpChars=function(u){return u?String(u).replace(s,"\\$&"):""};var o={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&#34;","'":"&#39;"},c=/[&<>'"]/g;function h(u){return o[u]||u}var m=`var _ENCODE_HTML_RULES = {
      "&": "&amp;"
    , "<": "&lt;"
    , ">": "&gt;"
    , '"': "&#34;"
